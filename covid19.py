...
def df_move1st_sg(df_t):
    ...
    df_t.loc[df_t[df_t['Country/Region'] == 'China'].index.values,'new'] = 0
...
#############################################################################
mapbox_access_token = 'pk.eyJ1IjoiY2VlY3giLCJhIjoiY2s5cWt5NDUzMGt4NDNydHJqODE0b3EwNyJ9.9MVEXAbEpkh0fvbit9GIMQ'
...
app.layout = html.Div(
    html.Div([
        ...
        html.Div(
            [
                html.H1(children='COVID-19 全球疫情动态实时追踪',
                        style={
                            'textAlign': 'left',
                            'color': colors['text'],
        ...
        html.Div([
            ...
            html.Div([
                ...
                html.P('死亡率: ' + str(round(df_deaths_total[-1]/df_confirmed_total[-1] * 100, 3)) + '%',
                       style={
                    'textAlign': 'center',
                    'color': colors['deaths_text'],
                }
            ...
            html.Div([
                ...
                html.P('治愈率: ' + str(round(df_recovered_total[-1]/df_confirmed_total[-1] * 100, 3)) + '%',
                       style={
                    'textAlign': 'center',
                    'color': colors['recovered_text'],
                }
        ...
        html.Div(
            [
                html.H4(children='全球 COVID-19 状况总览',
                         style={
                             'textAlign': 'center',
                             'color': colors['text'],
                             'backgroundColor': colors['background'],
